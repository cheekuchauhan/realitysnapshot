...
import net.mcreator.therealrealityofminecraft.item.TitaniumChunksItem;
import net.mcreator.therealrealityofminecraft.item.TinIngotsItem;
import net.mcreator.therealrealityofminecraft.item.CopperItem;
import net.mcreator.therealrealityofminecraft.block.TitaniumOreBlock;
import net.mcreator.therealrealityofminecraft.block.TinOreBlock;
...
public class AlloyFurnaceOnUpdateTickProcedure extends TheRealRealityOfMinecraftModElements.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((TheRealRealityOfMinecraftModVariables.WorldVariables.get(world).alloyfurnacelogic) == (true))) {
			...
			}.getItemStack((int) (0))).getItem() == new ItemStack(TitaniumOreBlock.block, (int) (1)).getItem()) && ((new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
					...
					private void run() {
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								Object invobj = ((Supplier) _current).get();
								if (invobj instanceof Map) {
									ItemStack _setstack = new ItemStack(TitaniumChunksItem.block, (int) (1));
									_setstack.setCount((int) 2);
									((Slot) ((Map) invobj).get((int) (2))).putStack(_setstack);
									_current.detectAndSendChanges();
								}
			...
			}.getItemStack((int) (0))).getItem() == new ItemStack(TinOreBlock.block, (int) (1)).getItem()) && ((new Object() {
				public ItemStack getItemStack(int sltid) {
					Entity _ent = entity;
					if (_ent instanceof ServerPlayerEntity) {
						Container _current = ((ServerPlayerEntity) _ent).openContainer;
					...
					private void run() {
						...
						if (entity instanceof PlayerEntity) {
							...
							if (_current instanceof Supplier) {
								Object invobj = ((Supplier) _current).get();
								if (invobj instanceof Map) {
									ItemStack _setstack = new ItemStack(TinIngotsItem.block, (int) (1));
									_setstack.setCount((int) 2);
									((Slot) ((Map) invobj).get((int) (2))).putStack(_setstack);
									_current.detectAndSendChanges();
								}
