...
public class UraniumOreBlock extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:uranium_ore")
	public static final Block block = null;
	public UraniumOreBlock(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GROUND).hardnessAndResistance(5f, 4.5f).lightValue(0).harvestLevel(4)
