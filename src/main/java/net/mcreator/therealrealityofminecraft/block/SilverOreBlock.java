...
public class SilverOreBlock extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 8);
	}
