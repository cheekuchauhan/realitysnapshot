...
public class CopperOreBlock extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 3);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 10)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(20, 0, 0, 72))));
		}
	}
}
