...
public class BerylliumBlock extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:beryllium")
	public static final Block block = null;
	public BerylliumBlock(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 10);
	}
