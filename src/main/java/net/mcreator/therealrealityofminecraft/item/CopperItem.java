...
public class CopperItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:copper")
	public static final Item block = null;
	public CopperItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 31);
	}
