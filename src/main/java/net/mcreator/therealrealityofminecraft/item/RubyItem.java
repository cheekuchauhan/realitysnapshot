...
public class RubyItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:ruby")
	public static final Item block = null;
	public RubyItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 47);
	}
