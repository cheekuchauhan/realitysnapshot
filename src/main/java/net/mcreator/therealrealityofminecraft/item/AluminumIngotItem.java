...
public class AluminumIngotItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:aluminum_ingot")
	public static final Item block = null;
	public AluminumIngotItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 56);
	}
