...
public class SapphireItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:sapphire")
	public static final Item block = null;
	public SapphireItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 43);
	}
