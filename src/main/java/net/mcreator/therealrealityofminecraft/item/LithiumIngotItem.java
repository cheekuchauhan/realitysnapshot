...
public class LithiumIngotItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:lithium_ingot")
	public static final Item block = null;
	public LithiumIngotItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 66);
	}
