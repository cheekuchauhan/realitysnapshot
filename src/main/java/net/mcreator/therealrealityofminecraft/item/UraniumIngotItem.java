...
public class UraniumIngotItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:uranium_ingot")
	public static final Item block = null;
	public UraniumIngotItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 61);
	}
