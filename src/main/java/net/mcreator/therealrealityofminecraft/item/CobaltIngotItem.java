...
public class CobaltIngotItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:cobalt_ingot")
	public static final Item block = null;
	public CobaltIngotItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 57);
	}
