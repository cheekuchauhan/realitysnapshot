...
public class LeadIngotItem extends TheRealRealityOfMinecraftModElements.ModElement {
	@ObjectHolder("the_real_reality_of_minecraft_:lead_ingot")
	public static final Item block = null;
	public LeadIngotItem(TheRealRealityOfMinecraftModElements instance) {
		super(instance, 51);
	}
